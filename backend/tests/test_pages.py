...
class TestPageFiltering:
    ...
    def test_superuser_sees_all_admin_pages(self):
        ...
        @quiver_page(
            route="/admin/a", layout="admin", title="A", component="A", permission="a.view"
        )
        class A(QuiverPage):
            pass

        @quiver_page(
            route="/admin/b", layout="admin", title="B", component="B", permission="b.view"
        )
        class B(QuiverPage):
            pass
    ...
    def test_portal_page_filtered_by_role(self):
        ...
        @quiver_page(
            route="/portal/x", layout="portal", title="X", component="X", allowed_roles=["premium"]
        )
        class X(QuiverPage):
            pass
