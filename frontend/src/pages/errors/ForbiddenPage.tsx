...
export function ForbiddenPage() {
  ...
  return (
    <div className="min-h-[60vh] flex flex-col items-center justify-center text-center">
      ...
      <div className="text-xl font-semibold text-gray-900 mb-2">{t('errors.forbiddenTitle')}</div>
      <div className="text-base text-gray-600 mb-7">{t('errors.forbiddenMessage')}</div>
